...
label define Education_label 0 "Less than high school diploma" 1 "High school degree or diploma" 2 "Some college, no degree" 3 "Associate's degree" 4 "Bachelor's degree" 5 "Post graduate work/degree or professional degree" 
...
//MALE
gen male = .
replace male = 0 if Genderascapturedinrawsurvey == "Female" | Genderascapturedinrawsurvey == "Non-binary / third gender" | Genderascapturedinrawsurvey == "I use another term (specify): " 
replace male = 1 if Genderascapturedinrawsurvey == "Male"
replace male = . if Genderascapturedinrawsurvey == "Don't know" | Genderascapturedinrawsurvey == "Prefer not to answer"
tab male, m
...
label define Insurance_own_label 1 "Renter with insurance" 2 "Renter without insurance" 3 "Owner with insurance" 4 "Owner without insurance"
label values insurance_ownership Insurance_own_label
tab insurance_ownership, m
...
replace simple_employment = 0 if Employmentascapturedinrawsu == "No, I have been unemployed for less than 1 month" ///
...
label define Preparedness_stage_label 0 "I am NOT prepared, and I do not intend to prepare in the next year" 1 "I am NOT prepared, but I intend to start preparing in the next year" 2 "I am NOT prepared, but I intend to get prepared in the next six months" 3 "I have been prepared for the last year" 4 "I have been prepared for MORE than a year and I continue preparing"
